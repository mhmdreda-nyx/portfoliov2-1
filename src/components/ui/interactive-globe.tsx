...
const DEFAULT_CONNECTIONS: { from: [number, number]; to: [number, number] }[] = [
    { from: [30.06, 31.24], to: [51.51, -0.13] },
    { from: [30.06, 31.24], to: [37.78, -122.42] },
    { from: [30.06, 31.24], to: [1.35, 103.82] },
    ...
    { from: [28.61, 77.21], to: [30.06, 31.24] },
...
export function InteractiveGlobe({
    className,
    size = 500,
    dotColor = "rgba(0, 255, 150, ALPHA)",
    arcColor = "rgba(0, 255, 150, 0.4)",
    markerColor = "rgba(0, 255, 200, 1)",
    ...
    const draw = useCallback(() => {
        ...
        glowGrad.addColorStop(0, "rgba(0, 255, 150, 0.04)");
